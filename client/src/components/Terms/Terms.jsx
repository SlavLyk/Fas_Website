      ...
      <div className="bg-black">
        <div className="flex-container-main">
          <div className="blur-container-1">
            ...
            <h1>Terms & Conditions for Floating Axe Studios</h1>
            <p>
            ...
            <p>
              is committed to ensuring that the app is as useful and efficient
            ...
            <p>
              The Floating Axe Studios app stores and processes personal data
              ...
              security features and it could mean that the Floating Axe Studios
            ...
            <p>
              You should be aware that there are certain things that will not
              ...
              be Wi-Fi or provided by your mobile network provider, but cannot
            ...
            <p>
              Along the same lines, cannot always take responsibility for the
              ...
              to avail the Service, cannot accept responsibility.
            </p>{" "}
            <p>
              ...
              we can make it available to you. accepts no liability for any
            ...
            <p>These terms and conditions are effective as of 2022-09-07</p>{" "}
            <p>
              <h2>Contact Us</h2>
            </p>{" "}
            <p>
