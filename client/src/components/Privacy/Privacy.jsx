      ...
      <div className="bg-black">
        <div className="flex-container-main">
          <div className="blur-container-1">
            ...
            <h1>Privacy Policy for Floating Axe Studios</h1>

            <p>
              At Floating Axe Studios, accessible from
              www.floatingaxestudios.com, one of our main priorities is the
              privacy of our visitors. This Privacy Policy document contains
              types of information that is collected and recorded by Floating
              Axe Studios and how we use it. If you have additional questions or
            ...
            <p>
              Floating Axe Studios legal basis for collecting and using the
            ...
            <ul>
              <li>Floating Axe Studios needs to perform a contract with you</li>
              <li>You have given Floating Axe Studios permission to do so</li>
              <li>
                Processing your personal information is in Floating Axe Studios
                legitimate interests
              </li>
              <li>Floating Axe Studios needs to comply with the law</li>
            </ul>

            <p>
              Floating Axe Studios will retain your personal information only
            ...
            <p>
              Floating Axe Studios follows a standard procedure of using log
            ...
            <p>
              Like any other website, Floating Axe Studios uses 'cookies'. These
            ...
            <p>
              ...
              the advertising partners of Floating Axe Studios.
            </p>

            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on Floating Axe
            ...
            <p>
              Note that Floating Axe Studios has no access to or control over
            ...
            <p>
              Floating Axe Studios's Privacy Policy does not apply to other
            ...
            <p>
              Floating Axe Studios does not knowingly collect any Personal
            ...
            <p>
              ...
              that they shared and/or collect in Floating Axe Studios. This
